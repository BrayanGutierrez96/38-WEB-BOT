...
//         console.log("Saca el huevo de la olla o cometelo ahí si quieres");   
//         console.log("Ummmm disfruta de tu huevo cocido"); 
//     }else{
//         console.log("Prepara la sarten");   
//         console.log("echa el huevo");   
...
//     if( numero1 == number ||  typeof numero2 == Number && typeof numero3 == Number){
//         console.log(total);
//     }else{
...
//     let numero1Entero = parseInt(num1)
//     let numero2Entero = parseInt(num2)
//     let numero3Entero = parseInt(num3)
//     const numeros = [numero1Entero, numero2Entero, numero3Entero];
//     let total = 0;
